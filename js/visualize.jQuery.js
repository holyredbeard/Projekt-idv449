...
$.fn.visualize = function(options, container){
  return $(this).each(function(){
    ...
    var o = $.extend({
      ...
      pieLabelPos: 'inside',
      lineWeight: 1, //for line and area - stroke weight
      barGroupMargin: 10,
          ...
          if(o.parseDirection == 'x'){
            self.find('tr:gt(0)').filter(o.rowFilter).each(function(i){
              ...
              $(this).find('td').filter(o.colFilter).each(function(){
                dataGroups[i].points.push( parseFloat($(this).html()) );
              });
            });
          }
          else {
    ...
    var createChart = {
      ...
      line: function(area){
        ...
        $.each(xLabels, function(i){ 
          var thisLi = $('<li><span class="monthData">'+this+'</span></li>')
      ...
      bar: function(){
        ...
        var i = 1;
        $.each(xLabels, function(i){
          var colorLabel = 'colorLabel' + i;
          var thisLi = $('<li><span class="label crimeData ' + colorLabel + '">&nbsp;</span></li>')
            .prepend('<span class="line" />')
            .css('left', xInterval * i)
            .width(xInterval)
            .appendTo(xlabelsUL);
    ...
    if(o.appendKey){
      ...
      selector.each(function(i){
        $('<li><span class="visualize-key-color" style="background: white"></span><span class="visualize-key-label">'+ $(this).text() +'</span></li>')
          .appendTo(newKey);
      });
